        ...
        body: Center(
            child: SingleChildScrollView(
              child: Column(
                ...
                children: <Widget>[
                  Text("Selected crops of damage farm"),
...
//                            leading: Icon(Icons.arrow_drop_down_circle),
                      ...
                      subtitle: Text(
                        _lossDate == null? 'Please pick a date' : DateFormat('MM/dd/yyyy').format(_lossDate),
...
//                            leading: Icon(Icons.arrow_drop_down_circle),
                      ...
                      subtitle: Text(
                        _estimatedHarvestDate == null? 'Please pick a date' : DateFormat('MM/dd/yyyy').format(_estimatedHarvestDate),
                        style: TextStyle(color: Colors.black.withOpacity(0.6)),
                      ),
                      trailing: ElevatedButton.icon(
                        label: Text('Set Date'),
